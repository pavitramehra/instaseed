...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2019/02/10', function(event) {
	...
	_tg_upcomingeventcountervtwo.countdown('2019/02/10', function(event) {
		var $this = jQuery(this).html(event.strftime(''
...
/*	var _tg_locationmap = jQuery("#tg-locationmap");
	_tg_locationmap.gmap3({
		marker: {
			position:[28.6131119, 77.0352845],
			address: "NSUT, Delhi, India",
			options: {
